...
function form() {
	...
	const codeWithRelativeImage = (img) =>
		`<div style="font-family: 'Montserrat', 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; font-size: 12pt; background: white; box-sizing: border-box;"><p style="margin-bottom: 0cm;"><span style="font-size: 11.0pt; color: #666666; ">${
			formData.name
		}</span></p><strong><span style="color: #434343;">${
			formData.sector
		}</span></strong><p style="margin-bottom: 4px;"><span style="font-size: 11.0pt; color: black;"><a href="mailto:${fullEmail}">${fullEmail}</a></span></p><div style="padding: 24px 0px 12px"><img src="${img}" border="0" width=${
			formData.image === "general" ? "120px" : "150px"
